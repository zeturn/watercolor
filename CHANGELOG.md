...
### Fixed
- Fixed Angular package ESM output so relative imports resolve correctly in strict Node/module consumers.
- Stopped the Svelte package root from importing CSS automatically; consumers can import `@zeturn/watercolor-svelte/theme.css` explicitly.
- Added Svelte to the GitHub trusted-publishing release workflow.
