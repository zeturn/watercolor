  ...
  render: () => ({
    ...
    template: `
      <div class="space-y-6 max-w-2xl">
        <div>
          <h3 class="text-lg font-semibold mb-3">填充样式（默认）</h3>
        ...
        <div>
          <h3 class="text-lg font-semibold mb-3">边框样式</h3>
        ...
        <div>
          <h3 class="text-lg font-semibold mb-3">立体样式</h3>
      ...
      <div class="space-y-6 max-w-2xl">
        <div>
          ...
          <CardVue title="小卡片" size="small">
            <p class="opacity-80">内边距较小的紧凑卡片。</p>
          </CardVue>
        </div>
        ...
        <div>
          ...
          <CardVue title="中等卡片" size="medium">
            <p class="opacity-80">标准尺寸的卡片，平衡美观与空间利用。</p>
          </CardVue>
        </div>
        ...
        <div>
          ...
          <CardVue title="大卡片" size="large">
            <p class="opacity-80">内边距较大的宽松卡片，适合重要内容展示。</p>
          </CardVue>
        </div>
      </div>
    `,
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-sm opacity-75">前端工程师</p>
              </div>
            </div>
        ...
        <div>
          ...
          <div class="space-y-4">
            <CardVue title="填充样式" color="success" variant="filled">
              <p class="opacity-80">成功色的填充样式卡片。</p>
            </CardVue>
            <CardVue title="边框样式" color="success" variant="outlined">
              <p class="opacity-80">成功色的边框样式卡片。</p>
            </CardVue>
            <CardVue title="立体样式" color="success" variant="elevated">
              <p class="opacity-80">成功色的立体样式卡片。</p>
            </CardVue>
          </div>
        </div>
        
        <div>
          <h3 class="text-lg font-semibold mb-4">警告主题 - 不同尺寸</h3>
          <div class="space-y-4">
            <CardVue title="小卡片" color="warning" size="small">
              <p class="opacity-80">警告色的小尺寸卡片。</p>
            </CardVue>
            <CardVue title="中等卡片" color="warning" size="medium">
              <p class="opacity-80">警告色的中等尺寸卡片。</p>
            </CardVue>
            <CardVue title="大卡片" color="warning" size="large">
              <p class="opacity-80">警告色的大尺寸卡片。</p>
            </CardVue>
          </div>
        </div>
      </div>
