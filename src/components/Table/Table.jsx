...
export const Table = ({
  ...
  return (
    <div
      className={`wc-table-container${stickyHeader ? ' wc-table-container--sticky' : ''} ${className}`}
      {...rest}
    >
      <table
        className={`wc-table wc-table--${size}${hover ? ' wc-table--hover' : ''}${striped ? ' wc-table--striped' : ''}${dense ? ' wc-table--dense' : ''}`}
      >
...
export const TableHead = ({ children, className = '', ...rest }) => {
  ...
  return (
    <thead className={`wc-table-head${stickyHeader ? ' wc-table-head--sticky' : ''} ${className}`} {...rest}>
      {children}
    </thead>
  )
}
...
export const TableBody = ({ children, className = '', ...rest }) => (
  <tbody className={`wc-table-body ${className}`} {...rest}>{children}</tbody>
)
...
export const TableCell = ({
  ...
  return (
    <Component className={classes} scope={Component === 'th' || variant === 'head' ? scope : undefined} {...rest}>
      {children}
    </Component>
  )
}
