...
- `references/components.md` — full React component catalog (import paths, key props, snippets). The same catalog applies to Next.js via `@zeturn/watercolor-next` and (by export name) to Svelte via `@zeturn/watercolor-svelte`.
