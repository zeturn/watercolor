...
export default {
  ...
  argTypes: {
    ...
    animated: { control: 'boolean', description: '是否启用动画' },
    transform: { 
      control: 'select', 
    ...
    hoverEffect: { control: 'boolean', description: '是否启用悬停效果' },
    infinite: { control: 'boolean', description: '是否无限循环' },
    size: { 
      control: 'select', 
      options: ['sm', 'md', 'lg', 'xl'],
      description: '尺寸变体'
    ...
    withQuotes: { control: 'boolean', description: '是否显示引用符号' },
    glow: { control: 'boolean', description: '是否启用发光效果' },
    gradient: { control: 'boolean', description: '是否启用渐变背景' },
    className: {
      control: 'text',
...
export const ClassicParadoxes = {
  render: () => ({
    components: { Paradox },
    template: `
      <div class="paradox-collection">
        <h3 class="paradox-title">经典悖论集合</h3>
        <div class="paradox-grid">
          <div class="paradox-section">
            <h4 class="paradox-section-title">逻辑悖论</h4>
            <Paradox 
              content="这句话是假的。"
          ...
          <div class="paradox-section">
            <h4 class="paradox-section-title">哲学悖论</h4>
            <Paradox 
              content="自由意志是一种幻觉。"
...
export const ModernParadoxes = {
  render: () => ({
    ...
    template: `
      <div class="paradox-collection">
        <h3 class="paradox-title">现代悖论</h3>
        <div class="paradox-categories">
          <div class="paradox-category paradox-category--tech">
            <h4 class="paradox-category-title">技术悖论</h4>
            <div class="paradox-category-content">
              <Paradox 
                content="技术让我们更加孤独。"
          ...
          <div class="paradox-category paradox-category--social">
            <h4 class="paradox-category-title">社会悖论</h4>
            <div class="paradox-category-content">
              <Paradox 
                content="选择越多，幸福越少。"
          ...
          <div class="paradox-category paradox-category--existential">
            <h4 class="paradox-category-title">存在悖论</h4>
            <div class="paradox-category-content">
              <Paradox 
                content="死亡给生命以意义。"
...
export const InteractiveParadox = {
  render: () => ({
    ...
    template: `
      <div class="paradox-collection">
        <h3 class="paradox-title">互动悖论</h3>
        <p class="paradox-description">
          将鼠标悬停在下面的悖论上查看提示，点击查看详细解释。
        </p>
        
        <div class="paradox-interactive">
          <div v-for="(item, index) in paradoxes" :key="index" class="paradox-item">
            <Paradox 
              :content="item.content"
              :tooltip="item.tooltip"
            />
            <details class="paradox-explanation">
              <summary class="paradox-explanation-summary">点击查看解释</summary>
              <p class="paradox-explanation-text">
                {{ item.explanation }}
              </p>
            </details>
          </div>
        ...
        <div class="paradox-tip">
          <h4 class="paradox-tip-title">🤔 思考提示</h4>
          <p class="paradox-tip-text">
...
export const Variants = {
  render: () => ({
    ...
    template: `
      <div class="paradox-collection">
        <h3 class="paradox-title">样式变体</h3>
        <div class="paradox-variants">
          <div class="paradox-variant-group">
            <h4 class="paradox-variant-title">尺寸变体</h4>
          ...
          <div class="paradox-variant-group">
            <h4 class="paradox-variant-title">颜色变体</h4>
          ...
          <div class="paradox-variant-group">
            <h4 class="paradox-variant-title">边框样式</h4>
          ...
          <div class="paradox-variant-group">
            <h4 class="paradox-variant-title">特殊效果</h4>
