...
export default {
  title: 'Components/Blockquote (Vue)',
...
export const Colors = {
  render: () => ({
    ...
    template: `
      <div style="padding: 16px; max-width: 600px;">
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">默认色（灰色）</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">主题色（蓝色）</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">成功色（绿色）</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">警告色（橙色）</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">错误色（红色）</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">信息色（青色）</h3>
...
export const ColoredVariants = {
  render: () => ({
    ...
    template: `
      <div style="padding: 16px; max-width: 600px;">
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">成功主题 - 不同变体</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">主题色 - 不同尺寸</h3>
          <div style="margin-bottom: 12px;">
...
export const Variants = {
  render: () => ({
    ...
    template: `
      <div style="padding: 16px; max-width: 600px;">
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">默认样式（浅灰背景，无边框）</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">简约样式</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">卡片样式</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">传统样式（有左边框）</h3>
...
export const Sizes = {
  render: () => ({
    ...
    template: `
      <div style="padding: 16px; max-width: 600px;">
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">小尺寸</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">中等尺寸（默认）</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">大尺寸</h3>
...
export const InteractiveDemo = {
  render: () => ({
    ...
    template: `
      <div style="padding: 16px; max-width: 600px;">
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">启用交互效果（默认）</h3>
        ...
        <div>
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px;">禁用交互效果</h3>
