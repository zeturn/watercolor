...
export const Sizes = {
  render: () => ({
    ...
    template: `
      <div class="w-full max-w-6xl mx-auto p-8 space-y-12">
        <div>
        ...
        <div>
          <h3 class="text-lg font-semibold mb-4">中等尺寸画廊</h3>
          <ImageGalleryVue 
            :images="smallImages"
            title="中等尺寸"
            size="md"
        ...
        <div>
          <h3 class="text-lg font-semibold mb-4">大尺寸画廊</h3>
          <ImageGalleryVue 
            :images="smallImages"
            title="大尺寸"
            size="lg"
        ...
        <div>
          <h3 class="text-lg font-semibold mb-4">特大尺寸画廊</h3>
          <ImageGalleryVue 
            :images="smallImages"
            title="特大尺寸"
            size="xl"
