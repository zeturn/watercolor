...
export const FlexContainer = {
  ...
  render: (args) => ({
    ...
    template: `
      <Box v-bind="args">
        <div style="padding: 8px; background: #1976d2; color: white; border-radius: 4px;">项目1</div>
        <div style="padding: 8px; background: #1976d2; color: white; border-radius: 4px;">项目2</div>
        <div style="padding: 8px; background: #1976d2; color: white; border-radius: 4px;">项目3</div>
      </Box>
    `
  })
}
