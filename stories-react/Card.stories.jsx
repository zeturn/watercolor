...
export const Colors = {
  render: () => (
    <div className="wc-grid wc-grid-cols-1 wc-md-grid-cols-2 wc-gap-6 wc-max-w-4xl">
...
export const Variants = {
  render: () => (
    <div className="wc-space-y-6 wc-max-w-2xl">
      <div>
        <h3 className="wc-text-lg wc-font-semibold wc-mb-3">填充样式（默认）</h3>
      ...
      <div>
        <h3 className="wc-text-lg wc-font-semibold wc-mb-3">边框样式</h3>
      ...
      <div>
        <h3 className="wc-text-lg wc-font-semibold wc-mb-3">简约样式</h3>
      ...
      <div>
        <h3 className="wc-text-lg wc-font-semibold wc-mb-3">立体样式</h3>
...
export const Sizes = {
  render: () => (
    <div className="wc-space-y-6 wc-max-w-2xl">
      <div>
        <h3 className="wc-text-lg wc-font-semibold wc-mb-3">小尺寸</h3>
        <Card title="小卡片" size="small">
          <p className="wc-opacity-80">内边距较小的紧凑卡片。</p>
        </Card>
      </div>
      
      <div>
        <h3 className="wc-text-lg wc-font-semibold wc-mb-3">中等尺寸（默认）</h3>
        <Card title="中等卡片" size="medium">
          <p className="wc-opacity-80">标准尺寸的卡片，平衡美观与空间利用。</p>
        </Card>
      </div>
      
      <div>
        <h3 className="wc-text-lg wc-font-semibold wc-mb-3">大尺寸</h3>
        <Card title="大卡片" size="large">
          <p className="wc-opacity-80">内边距较大的宽松卡片，适合重要内容展示。</p>
        </Card>
      </div>
    </div>
  ),
