...
import { createThemeController, applyThemeConfig, resetThemeConfig, createThemeInitScript, THEME_MODES, } from '../utils/theme';
const here = dirname(fileURLToPath(import.meta.url));
describe('@zeturn/watercolor-svelte public surface', () => {
    ...
    it('exports every name required by api-manifest.json', () => {
        const manifest = JSON.parse(readFileSync(resolve(here, '../../../../api-manifest.json'), 'utf8'));
