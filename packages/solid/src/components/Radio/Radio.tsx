  ...
  return (
    ...
    >
      <div class={groupClasses}>
        {label && (
          <label class="wc-radio-group-label">
            {label}
            {required && <span class="wc-radio-group__required">*</span>}
          </label>
        )}
        ...
        {(error || helperText) && (
          <div class="wc-radio-group__message">
            {error ? (
              <p class="wc-radio-group__error">{error}</p>
            ) : (
              <p class="wc-radio-group__helper">{helperText}</p>
            )}
          </div>
        )}
      </div>
  ...
  return (
    <label class={containerClasses}>
      ...
      <span class={radioButtonClasses}>
        {isChecked && <span class="radio-dot" />}
      </span>
      {labelContent && <span class="radio-label">{labelContent}</span>}
    </label>
  )
}
