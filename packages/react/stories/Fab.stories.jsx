import Fab from '../src/components/Button/Fab.jsx'

export default {
  title: 'Components/Fab (React)',
  component: Fab,
  parameters: {
    docs: {
      description: {
...
export const Positioning = {
  render: () => (
    <div style={{ position: 'relative', height: '300px', background: '#f9fafb', borderRadius: '8px', overflow: 'hidden' }}>
