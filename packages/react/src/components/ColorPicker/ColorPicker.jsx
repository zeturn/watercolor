...
export default function ColorPicker({ 
  ...
  return (
    <span className={colorPickerClasses} ref={rootRef}>
      <button
        type="button"
        disabled={disabled}
      ...
      {isOpen && (
        <div className="wc-color-picker__popover" ref={popoverRef} role="dialog" aria-label={messages.colorPicker}>
          <div className="wc-color-picker__current">
            <span className="wc-color-picker__current-preview" style={previewStyles} />
            <label className="wc-color-picker__field">
              <span className="wc-color-picker__field-label">Hex</span>
              <input
          ...
          <div className="wc-color-picker__swatches" role="listbox" aria-label="Color swatches">
            {swatches.map((swatch) => {
              ...
              return (
                <button
                  ...
                  className={`wc-color-picker__swatch ${isSelected ? 'wc-color-picker__swatch--selected' : ''}`}
